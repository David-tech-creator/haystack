  ...
  return (
    <article className="container grid gap-10 py-16 sm:py-24 lg:grid-cols-[minmax(0,2fr),minmax(0,1fr)]">
      ...
      <aside className="space-y-4">
        ...
        <div className="rounded-3xl border border-[#e3d7be]/60 bg-[#fef8ec]/85 p-6 text-sm text-muted-foreground shadow-sm backdrop-blur dark:border-[#cbbd9e]/30 dark:bg-navy-900/40">
          <h2 className="text-lg font-semibold text-primary dark:text-wheat-50">Impact</h2>
          <ul className="mt-3 space-y-2">
